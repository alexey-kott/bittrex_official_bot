...
class Btn():
	def __init__(self):
		...
		self.referal 		= "Пригласи друга — получи скидку"
...
class Msg():
	def __init__(self):
		...
		self.referal_manual = '''
		Просто перешлите следующее сообщение человеку, которого хотите пригласить и как только он купит подписку — вам начислится скидка.
